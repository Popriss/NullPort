...
export default function Button({
  ...
  const base = "relative inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-xs font-mono font-semibold tracking-wide transition-all duration-150 active:scale-[0.98] gpu-layer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-[#050a08] disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer select-none";
  const variants = {
    primary: "bg-[#10b981] hover:bg-[#34d399] text-[#050a08] font-bold focus:ring-[#10b981] shadow-[0_0_20px_rgba(16,185,129,0.25)] hover:shadow-[0_0_28px_rgba(16,185,129,0.4)]",
